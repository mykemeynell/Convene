...
<nav class="navbar navbar-expand navbar-light bg-{{ isset($topbar_color) ? $topbar_color : 'white' }} topbar mb-4 static-top shadow @if(isset($topbar_classes)) {{ $topbar_classes }} @endif">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <ul class="list-unstyled my-auto mr-3 list-inline">
            ...
            <li class="list-inline-item">
                <a href="#" class="btn btn-outline-primary btn-round" id="js-save-exit-page-button" data-then="close">Save &amp; Finish</a>
            </li>
            @endif
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ $user->getDisplayName() }}</span>
                @include('layouts.components._avatar', ['avatar_classes' => 'img-profile rounded-circle'])
            </a>
